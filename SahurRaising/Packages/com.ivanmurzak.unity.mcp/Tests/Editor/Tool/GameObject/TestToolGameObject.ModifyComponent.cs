...
namespace com.IvanMurzak.Unity.MCP.Editor.Tests
{
    public partial class TestToolGameObject : BaseTest
    {
        ...
        public IEnumerator ModifyComponent_Vector3()
        {
            ...
            int? dataChildInstanceID = data.GetField(nameof(child.transform))?.TryGetInstanceID(out var tempChildInstanceId) ?? false
                ? tempChildInstanceId
                : null;
        ...
        public IEnumerator ModifyJson_SolarSystem_PlanetsArray()
        {
            ...
            Assert.IsNotNull(serializedMember, "SerializedMemberList should be deserialized.");
