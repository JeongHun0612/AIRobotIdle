...
## 내가 걍 보기위한 텍스트
49:58:SahurRaising/Docs/game_design.md
### 3.2. 강화 시스템 (골드)
- 재화: 골드
...
87:98:SahurRaising/Docs/game_design.md
### 3.3. 스킬 시스템 (에메랄드)
- 재화: 에메랄드 (성장/퀴즈 보상)
...
99:108:SahurRaising/Docs/game_design.md
### 3.4. 장비 시스템 (다이아몬드)
- 재화: 다이아몬드 (성장/광고/인앱결제)
...
- 강화: 루비 사용. 레벨당 보유 옵션 20% 증가.
...
112:116:SahurRaising/Docs/game_design.md
### 3.5. 퀴즈 시스템 (티켓)
- 입장 재화: 티켓